...
const About = () => {
  return (
    <div className="min-h-screen w-full flex justify-center">
      ...
      <div className="bg-white p-6 mt-4 mb-2 rounded-lg shadow-md">
        <h2 className="text-2xl font-bold mb-6 text-pink-800 md:text-4xl">About FoodMania</h2>
        <p className="text-lg text-gray-700 md:text-xl">
            FoodMania was founded in 2025 with a mission to make delicious and fresh food accessible to everyone.
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          <h2 className="text-2xl font-bold mb-6 text-pink-800 md:text-4xl">Services</h2>
          <p className="text-lg text-gray-700 mb-6 md:text-xl">
            At FoodMania, we are dedicated to providing the best food delivery service with a wide range of options to 
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-700 md:text-lg">
            <li>Fast and Fresh food delivery</li>
            <li>Wide variety of Resturant to choose from</li>
            <li>Easy-to-use UI and Ux for hassle-free ordering</li>
            <li>Exclusive deals and discounts for beloved customers</li>
            <li>24/7 customer support to assist you with any queries</li>
          </ul>
        </div>

        <div className="bg-white p-6 mt-4 rounded-lg shadow-md">
          <h2 className="text-2xl font-bold mb-6 text-pink-800 md:text-4xl">Why Prefer Us?</h2>
          <p className="text-lg text-gray-700 mb-6 md:text-xl">
          FoodMania stands out in the food delivery market because we prioritize customer satisfaction and quality above all else. Here’s why you should choose us:
          </p>
          <ul className="list-disc list-inside space-y-2 text-gray-700 md:text-lg">
        ...
        <div className="bg-white p-6 mt-4 rounded-lg shadow-md">
          <h2 className="text-2xl font-bold mb-6 text-pink-800 md:text-4xl">Our Mission</h2>
          <p className="text-lg text-gray-700 mb-6 md:text-xl">
